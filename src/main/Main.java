...
public class Main {
	...
	public static boolean addDepartment(String newName) {
		...
		} catch (EmptyGuildNameException blank) {
			System.out.println(blank);

		} catch (DuplicateGuildNameException same) {
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		System.out.println("Department removed. " + myDatabase.getDepartment(index).memberCount()
				+ " member(s) added to Unassigned Department.");

		getUnassignedDepartment().addMultipleMembers(myDatabase.removeDepartment(index));
	}
